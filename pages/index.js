  ...
  return (
    <>
      ...
      <main className="container">
        ...
        <section>
          ...
          <div className="info-cards" style={{
            ...
            <article style={{ background: "white", padding: "1rem", borderRadius: "0.75rem", width: "280px", boxShadow: "0 0 10px rgba(0, 0, 0, 0.05)", textAlign: "center" }}>
      ...
      <div id="chat-container" style={{
        ...
        <div id="chat-header" style={{ background: "#165f2e", color: "white", textAlign: "center", padding: "0.5rem", fontWeight: "bold", fontSize: "1rem" }}>
          VaidhGPT
        </div>
